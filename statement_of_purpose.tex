...
\usepackage[a4paper,margin=1.0in,noheadfoot]{geometry}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\begin{center}{\large \scshape \hspace{1pt} \yourname \hspace{200pt}  \youremail }\end{center}
\hrule
\begin{center}{\Large \scshape \soptitle \hspace{1pt} }\end{center}
