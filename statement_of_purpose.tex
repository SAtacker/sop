...
\usepackage[a4paper,margin=1.0in,includehead,headsep=.5in]{geometry}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\setlength{\headheight}{20.1308pt}
\addtolength{\topmargin}{-16.0pt}
\thispagestyle{fancy}
\fancyhead{}
\fancyhead[R]{\small \scshape \currentUniversity \\ \currentDegree \\ \vspace{2mm} }\\
\fancyhead[L]{\small \scshape \yourname \\ \youremail \\ \vspace{2mm}}\\
\fancyhead[C]{\large \scshape \soptitle}
