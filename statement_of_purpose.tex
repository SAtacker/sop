...
\usepackage[a4paper,margin=1.0in,includehead]{geometry}
...
\newcommand{\yourname}{Shreyas Atre}
\newcommand{\youremail}{shreyasatre16@gmail.com}
\newcommand{\purpose}{Masters in Computer Science}
\newcommand{\university}{Georgia Institute of Technology}
\newcommand{\currentUniversity}{Veermata Jijabai Technological Institute}
\newcommand{\currentDegree}{B.Tech. Electronics and Telecommunications}

%% FONTS SETUP
\defaultfontfeatures{Mapping=tex-text}
\setromanfont[Ligatures={Common}]{Times New Roman}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\addtolength{\topmargin}{-28.20839pt}
\thispagestyle{fancy}
\fancyhead{}
\fancyhead[R]{\small \scshape \currentUniversity \\ \currentDegree \\ \\}
\fancyhead[L]{\small \scshape \yourname \\ \youremail \\ \\}
\fancyhead[C]{\large \scshape \textbf{\soptitle}}
\vspace*{0.1em}
\begin{center}{\large \scshape \purpose \hspace{1pt} $-$ \hspace{1pt} \university }\end{center}
% \hrule
% \begin{center}{\Large \scshape  \hspace{1pt} }\end{center}
% \begin{center}{\large \scshape }\end{center}
